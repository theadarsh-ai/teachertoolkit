...
export class PDFGeneratorService {
    ...
    generateLessonPlanHTML(lessonPlan, rawContent) {
        if (!lessonPlan) {
      ...
      `;
        ...
        <div class="section">
          ...
          ${lessonPlan.dailyLessons.map((lesson) => `
              ...
              <div class="daily-content">
                <div class="daily-row">
                  ...
                  <div class="daily-value">
                    ${lesson.objectives ? `<ul>${lesson.objectives.map((obj) => `<li>${obj}</li>`).join('')}</ul>` : 'Not specified'}
                  </div>
                </div>
                ...
                <div class="daily-row">
                  ...
                  <div class="daily-value">
                    ${lesson.activities ? `<ul>${lesson.activities.map((activity) => `<li>${activity}</li>`).join('')}</ul>` : 'Standard classroom activities'}
                  </div>
                </div>
                ...
                <div class="daily-row">
                  ...
                  <div class="daily-value">
                    ${lesson.materials ? `<ul>${lesson.materials.map((material) => `<li>${material}</li>`).join('')}</ul>` : 'Basic classroom materials'}
                  </div>
                </div>
        ...
        <div class="section">
          ...
          <div class="ncert-alignment">
            ...
            ${lessonPlan.ncertAlignment.textbooks ? `
              <ul>
                ${lessonPlan.ncertAlignment.textbooks.map((book) => `
    ...
    addContentToPDF(doc, options, lessonPlan) {
        let currentY = 20;
        ...
        if (lessonPlan) {
            ...
            if (lessonPlan.objectives && lessonPlan.objectives.length > 0) {
                ...
                lessonPlan.objectives.forEach((obj, index) => {
            ...
            if (lessonPlan.dailyLessons && lessonPlan.dailyLessons.length > 0) {
                ...
                lessonPlan.dailyLessons.forEach((lesson) => {
    ...
    addSection(doc, title, currentY, margin, contentWidth, pageHeight) {
