...
class GooglePolyService {
    constructor(apiKey) {
        this.baseUrl = 'https://poly.googleapis.com/v1';
        this.apiKey = apiKey;
    }
    async searchAssets(query, maxResults = 20) {
        try {
    ...
    getMockEducationalModels(query) {
        ...
        const filteredAssets = mockAssets.filter(asset => asset.displayName.toLowerCase().includes(query.toLowerCase()) ||
...
//# sourceMappingURL=google-poly-api.js.map